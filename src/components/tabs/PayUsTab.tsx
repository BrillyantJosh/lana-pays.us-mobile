  ...
  return (
    <div className="flex flex-col gap-6 px-6 py-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="font-display text-xl font-bold text-foreground">Pay.Us</h2>
          <p className="text-muted-foreground text-sm">Vnesi podatke za plačilo</p>
        </div>
      </div>
